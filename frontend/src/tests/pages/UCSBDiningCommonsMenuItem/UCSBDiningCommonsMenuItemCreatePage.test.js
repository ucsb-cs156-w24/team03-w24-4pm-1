...
describe("UCSBDiningCommonsMenuItemCreatePage tests", () => {
	...
	expect(codeInput).toBeInTheDocument();
        ...
        fireEvent.change(nameInput, { target: { value: 'ortega' } })
        fireEvent.change(stationInput, { target: { value: 'ortega' } })
	fireEvent.change(codeInput, { target: { value: 'ortega' } })
        ...
        expect(mockToast).toBeCalledWith("New ucsbdiningcommonsmenuitem Created - id: 3 name: ortega");
