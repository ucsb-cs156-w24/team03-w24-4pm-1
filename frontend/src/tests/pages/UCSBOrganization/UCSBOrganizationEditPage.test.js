...
describe("UCSBOrganizationEditPage tests", () => {
    ...
    describe("tests where backend is working normally", () => {
        ...
        test("Is populated with the data provided", async () => {
            ...
            expect(orgTranslationShortField).toHaveValue("test-ts");
            expect(orgTranslationField).toHaveValue("test-t");
        ...
        test("Changes when you click Update", async () => {
            ...
            fireEvent.change(orgTranslationField, { target: { value: 'testing' } })
            fireEvent.change(inactiveField, { target: { value: true } })

            fireEvent.click(submitButton);

            await waitFor(() => expect(mockToast).toBeCalled());
            expect(mockToast).toBeCalledWith("UCSBOrganization Updated - orgCode: test orgTranslation: test-t");
