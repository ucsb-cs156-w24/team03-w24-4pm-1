  ...
  test("Has the expected column headers and content for ordinary user", () => {
    ...
    render(
      <QueryClientProvider client={queryClient}>
        <MemoryRouter>
          <UCSBDiningCommonsMenuItemTable diningcommonsmenuitem={ucsbDiningCommonsMenuItemFixtures.threeDiningCommonsMenuItem} currentUser={currentUser} />
        </MemoryRouter>
      </QueryClientProvider>

    );

    const expectedHeaders = ["id", "station", "name", "code"];
    const expectedFields = ["id", "station", "name", "code"]; 
