...
describe("ArticlesTable tests", () => {
  ...
  const expectedHeaders = ["id", "Title", "Url", "Explanation", "Email", "Date (iso format)"];
  ...
  test("Has the expected column headers, content and buttons for admin user", () => {
    ...
    expect(screen.getByTestId(`${testId}-cell-row-1-col-title`)).toHaveTextContent("Trump calls Florence 'one of the wettest we've ever seen from the standpoint of water");
