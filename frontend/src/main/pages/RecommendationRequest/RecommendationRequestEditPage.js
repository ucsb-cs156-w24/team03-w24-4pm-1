...
export default function RecommendationRequestEditPage({storybook=false}) {
  ...
  const onSuccess = (recommendationRequest) => {
    toast(`recommendationRequest Updated - id: ${recommendationRequest.id} professorEmail: ${recommendationRequest.professorEmail} requesterEmail: ${recommendationRequest.requesterEmail} explanation: ${recommendationRequest.explanation} dateRequested: ${recommendationRequest.dateRequested} dateNeeded: ${recommendationRequest.dateNeeded} done: ${recommendationRequest.done}`);
  }
