...
export default function RecommendationRequestCreatePage({storybook=false}) {
  ...
  const onSuccess = (recommendationRequest) => {
    toast(`New recommendationRequest Created - id: ${recommendationRequest.id} professorEmail: ${recommendationRequest.professorEmail} requesterEmail: ${recommendationRequest.requesterEmail}`);
  }
